<template>
  <div class="bohaopan">
    <el-row>
      <el-col :span="8">
        <div class="input">
          <el-input v-model="callNumber" clearable class="center" placeholder="请输入您要拨号的号码"></el-input>
        </div>

        <div class="container">
          <el-button @click="enterNumber1" class="enterNumber1">1</el-button>
          ...
          <el-button @click="enterNumberstar" class="enterNumberstar">*</el-button>
          <el-button @click="enterNumber0">0</el-button>
          <el-button @click="enterNumberwell">#</el-button>
          <el-button type="primary" icon="el-icon-phone" class="callButton" @click="calling">拨打</el-button>
        </div>
      </el-col>

      <el-col :span="8">
        <el-card shadow="hover" style="530px">
          <el-button type="primary" @click="dialogVisible = true">添加联系人</el-button>
          <el-button type="danger" @click="removeCont">移除联系人</el-button>
          <el-button type="primary" @click="callListCont">拨打联系人列表</el-button>
        </el-card>
      </el-col>
    </el-row>
    ...
    <div class="listView">
      <el-row>
        <div v-for="(item, index) in callList" :key="index">
          <el-col :span="4">
            <div class="container">
              <img src="../assets/img/headPortrait.png" class="phoneList-avator" alt />
              <h5 class="listclass">联系人名字:{{ item.name }}</h5>
              <h5 class="listclass">联系人电话:{{ item.phoneNumber }}</h5>
              <el-checkbox v-model="item.isChecked" class="listclass">选择连接</el-checkbox>
              <el-button v-show="isChosen" type="danger" @click="removeSomeOne(index)">123</el-button>
            </div>
          </el-col>
        </div>
      </el-row>
    ...
    <el-dialog title="联系人信息" :visible.sync="dialogVisible">
      <el-form :model="form">
        ...
        <el-form-item label="联系人号码">
          <el-input v-model="form.phoneNumber" placeholder="请输入号码"></el-input>
        </el-form-item>
      </el-form>
    ...
    callListCont() {
      this.callList.forEach(item => {
        if (item.isChecked) {
          ...
          console.log("TCL: callListCont -> chosenList", this.chosenList);
        }
      });
      this.toCall = true;
    },
